 ...
 * based on a set of filter options using HTTP from gelbooru.com. 
 * @extends {OnlinePictureProvider}
 */
export class GelbooruProvider extends OnlinePictureProvider {
    ...
    constructor() {
         ...
         * @type {String}
         */
        this._baseUrl = 'https://gelbooru.com/index.php?page=dapi&s=post&q=index';
         ...
         * @type {string}
         */
        this._name = GelbooruProvider.getName();
    }
    ...
    transformRawDataItem(rawDataItem) {
        const picture = new GelbooruPicture();
